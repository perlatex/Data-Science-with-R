...
knitr::include_graphics("./images/LINE.png")
```
...
```{r, out.width = '80%', fig.align = 'center', echo = FALSE}
knitr::include_graphics("./images/from_model_to_code.png")
```
...
`post_samples`是一个列表，每个元素对应一个系数，每个元素都有4000个样本，我们可以用ggplot2画出每个系数的后验分布
